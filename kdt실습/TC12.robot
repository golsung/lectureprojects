...
*** Test Cases ***
Students should get credits
    [Template]    Should get credits according to their points
    [Setup]    Visit Grader Home Page
    정인상1    컴퓨터공학    90    90    95    91.5    A
    정인상2    기계공학    85    85    80    83.5    B
    정인상3    컴퓨터공학    78    72    76    75.3    C
    정인상4    전자공학    66    67    60    64.55    D
    정인상5    컴퓨터공학    40    25    13    26.65    F
    [Teardown]    Run Keywords    Delete All Students In Table    Close Browser

...
class GraderLifeCycleTest {

	@BeforeAll
	static void setUpClass(TestInfo testInfo) {
		System.out.println("BeforeAll starts : " + testInfo.getDisplayName());
	}

	@AfterAll
	static void tearDownClass(TestInfo testInfo) {
		System.out.println("BeforeEach starts : " + testInfo.getDisplayName());
	}

	Grader grader;
	@BeforeEach
	void setUp(TestInfo testInfo) {
		System.out.println("BeforeEach starts : " + testInfo.getTestMethod());
		grader = new Grader();
	}

	@AfterEach
	void tearDown(TestInfo testInfo) {
		System.out.println("AfterEach starts : " + testInfo.getTestMethod());
	}
